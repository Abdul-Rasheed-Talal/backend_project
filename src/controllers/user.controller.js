...
const loginUser = asyncHandler(async (req, res) => {
    ...
    // username or email exists or not and whether to give access based on email or user (login)
    // find the user
    // password check
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200 , channel[0] , "User channel found sucessfully")
    )
})
